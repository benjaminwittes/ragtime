...
- **Corpora live in the corpus project:** federal **litigation** (`cases`/`docket_entries`/`documents`, post-1/20/2025 floor) + **FRUS** (State Dept documentary history, `frus_documents`, ingested 2026-05-23) + **OLC** opinions (`olc_opinions` — DOJ archive 1,439 + Knight FOIA net-new 706 = 2,145, ingested 2026-05-24). Ingest code is in the private `ragtime-pipeline` repo (`ingest/<corpus>/`). Content roadmap: litigation + FRUS + OLC + Lawfare's own content; FBI/declassified deferred.
