 ...
 * opinion corpus (OLC), and the historical-narrative corpus (FRUS).
 * Collection sub-spokes (per brief #7) will land in a separate registry
 * that inherits from this one when the collections architecture ships.
 */
